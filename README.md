...
- [v] Clone this repository, open the files and fill them out according to the directions
...
- [v] Exercise A: Create and link two pages (index.html and about.html)

  - [v] index.html, through an image, links to about.html document
  - [v] about.html has a link that opens the users mail system, to send an email

- [v] Exercise B: Floating Three Divs, recreate the image below using HTML and CSS, use css float.

  ![floatExercise](assets/floatExercise.png)

* [v] Exercise C: Flex Box Three Divs, recreate the image from the last exercise, use HTML and CSS, use css flex

* [v] Exercise D: Flowerbox VI - recreate the site using HTML and CSS, refer to the image below
...
- [v] Exercise E: Flowerbox VII: Add @media queries such that your page is styled appropriately for mobiles, change your CSS file.
